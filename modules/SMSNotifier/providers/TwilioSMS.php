...
class SMSNotifier_TwilioSMS_Provider implements SMSNotifier_ISMSProvider_Model {
	...
	const SERVICE_URI = '';
	private static $REQUIRED_PARAMETERS = array('account_sid', 'auth_token', 'from');
	...
	public function send($message, $toNumbers) {
		...
		$account_sid = $this->parameters['account_sid'];
		$auth_token = $this->parameters['auth_token'];
